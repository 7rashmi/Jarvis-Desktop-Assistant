...
if __name__ == "__main__": #main program
    ...
    # if 1:
        ...
        if "open notepad" in query:
            ...
            apath = r"C:\Program Files (x86)\Adobe\Reader 11.0\Reader\AcroRd32.exe"
            os.startfile(apath)
            ...
            music_dir = r"C:\Users\Rashmi Kanyal\Music"
            ...
            try:
                ...
                print(e)
                speak("sorry Ma'am, i am not able to sent this mail to Rashmi")
...
###########################################################################################################################################
           ...
           speak("please wait Ma'am, feteching the latest news")
           news()
